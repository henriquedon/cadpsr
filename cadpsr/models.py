...
class Colaborador(UserMixin, db.Model):
    ...
    nome_social = db.Column(db.String(60), index=True)
    ...
    data_atualizacao = db.Column(db.String(20))
...
class Entidade(db.Model):
    ...
    tipo_etd = db.Column(db.String(60))
    email = db.Column(db.String(60))
    telefone = db.Column(db.String(15))
    endereco = db.Column(db.String(100), index=True)
...
class Pessoa(db.Model):
    ...
    data_criacao = db.Column(db.String(20), nullable=True)
    data_atualizacao = db.Column(db.String(20), nullable=True)
    ...
    nome_social = db.Column(db.String(60), index=True, nullable=True)
    ...
    rg_orgao_emissor = db.Column(db.String(80), nullable=True)
    ...
    crnm_validade = db.Column(db.String(6), nullable=True)
    crnm_classificacao = db.Column(db.String(30), nullable=True)
    crnm_domicilio = db.Column(db.String(100), nullable=True)
    crnm_emissao = db.Column(db.String(6), nullable=True)
    questao_migracao = db.Column(db.String(3), nullable=True)
    questao_1 = db.Column(db.String(3), nullable=True)
    questao_2 = db.Column(db.String(3), nullable=True)
    questao_3 = db.Column(db.String(3), nullable=True)
    questao_4 = db.Column(db.String(3), nullable=True)
    questao_5 = db.Column(db.String(3), nullable=True)
    questao_6 = db.Column(db.String(3), nullable=True)
    questao_7 = db.Column(db.String(3), nullable=True)
    questao_8 = db.Column(db.String(3), nullable=True)
    questao_9 = db.Column(db.String(3), nullable=True)
    questao_10 = db.Column(db.String(3), nullable=True)
    questao_11 = db.Column(db.String(3), nullable=True)
    questao_12 = db.Column(db.String(3), nullable=True)
    questao_13 = db.Column(db.String(3), nullable=True)
    questao_14 = db.Column(db.String(3), nullable=True)
